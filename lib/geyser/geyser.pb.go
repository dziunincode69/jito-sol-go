...
import (
	confirmedblock "jito_client/lib/confirmed_block"
	reflect "reflect"
	sync "sync"
...
type BlockUpdate struct {
	...
	Rewards                  []*confirmedblock.Reward              `protobuf:"bytes,3,rep,name=rewards,proto3" json:"rewards,omitempty"`
...
func (x *BlockUpdate) GetRewards() []*confirmedblock.Reward {
	if x != nil {
		return x.Rewards
	}
	return nil
...
type TransactionUpdate struct {
	...
	Tx        *confirmedblock.ConfirmedTransaction `protobuf:"bytes,5,opt,name=tx,proto3" json:"tx,omitempty"`
}
...
func (x *TransactionUpdate) GetTx() *confirmedblock.ConfirmedTransaction {
	if x != nil {
		return x.Tx
	}
	return nil
...
var file_geyser_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x04,
...
var file_geyser_proto_goTypes = []interface{}{
	...
	(*confirmedblock.Reward)(nil),                                // 21: solana.storage.ConfirmedBlock.Reward
	(*confirmedblock.ConfirmedTransaction)(nil),                  // 22: solana.storage.ConfirmedBlock.ConfirmedTransaction
}
...
func file_geyser_proto_init() {
	...
	confirmedblock.File_confirmed_block_proto_init()
	if !protoimpl.UnsafeEnabled {
