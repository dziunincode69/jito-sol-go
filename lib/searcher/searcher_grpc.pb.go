...
type SearcherServiceClient interface {
	...
	SubscribePendingTransactions(ctx context.Context, in *PendingTxSubscriptionRequest, opts ...grpc.CallOption) (SearcherService_SubscribePendingTransactionsClient, error)
...
func (c *searcherServiceClient) SubscribeBundleResults(ctx context.Context, in *SubscribeBundleResultsRequest, opts ...grpc.CallOption) (SearcherService_SubscribeBundleResultsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearcherService_ServiceDesc.Streams[0], "/searcher.SearcherService/SubscribeBundleResults", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *searcherServiceClient) SubscribePendingTransactions(ctx context.Context, in *PendingTxSubscriptionRequest, opts ...grpc.CallOption) (SearcherService_SubscribePendingTransactionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearcherService_ServiceDesc.Streams[1], "/searcher.SearcherService/SubscribePendingTransactions", opts...)
	if err != nil {
		return nil, err
	}
	x := &searcherServiceSubscribePendingTransactionsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type SearcherService_SubscribePendingTransactionsClient interface {
	Recv() (*PendingTxNotification, error)
	grpc.ClientStream
}

type searcherServiceSubscribePendingTransactionsClient struct {
	grpc.ClientStream
}

func (x *searcherServiceSubscribePendingTransactionsClient) Recv() (*PendingTxNotification, error) {
...
func (c *searcherServiceClient) SubscribeMempool(ctx context.Context, in *MempoolSubscription, opts ...grpc.CallOption) (SearcherService_SubscribeMempoolClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearcherService_ServiceDesc.Streams[2], "/searcher.SearcherService/SubscribeMempool", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *searcherServiceClient) GetNextScheduledLeader(ctx context.Context, in *NextScheduledLeaderRequest, opts ...grpc.CallOption) (*NextScheduledLeaderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/searcher.SearcherService/GetNextScheduledLeader", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searcherServiceClient) GetConnectedLeaders(ctx context.Context, in *ConnectedLeadersRequest, opts ...grpc.CallOption) (*ConnectedLeadersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/searcher.SearcherService/GetConnectedLeaders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searcherServiceClient) GetConnectedLeadersRegioned(ctx context.Context, in *ConnectedLeadersRegionedRequest, opts ...grpc.CallOption) (*ConnectedLeadersRegionedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/searcher.SearcherService/GetConnectedLeadersRegioned", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searcherServiceClient) GetTipAccounts(ctx context.Context, in *GetTipAccountsRequest, opts ...grpc.CallOption) (*GetTipAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/searcher.SearcherService/GetTipAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searcherServiceClient) GetRegions(ctx context.Context, in *GetRegionsRequest, opts ...grpc.CallOption) (*GetRegionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/searcher.SearcherService/GetRegions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearcherServiceServer interface {
	...
	// Any transactions that write-lock the provided accounts will be streamed to the searcher.
	// NOTE: DEPRECATED SOON!!!
	SubscribePendingTransactions(*PendingTxSubscriptionRequest, SearcherService_SubscribePendingTransactionsServer) error
	// RPC endpoint to subscribe to mempool based on a few filters
...
func (UnimplementedSearcherServiceServer) SubscribePendingTransactions(*PendingTxSubscriptionRequest, SearcherService_SubscribePendingTransactionsServer) error {
	return status.Errorf(codes.Unimplemented, "method SubscribePendingTransactions not implemented")
}
...
func _SearcherService_SubscribePendingTransactions_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PendingTxSubscriptionRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SearcherServiceServer).SubscribePendingTransactions(m, &searcherServiceSubscribePendingTransactionsServer{stream})
}

type SearcherService_SubscribePendingTransactionsServer interface {
	Send(*PendingTxNotification) error
	grpc.ServerStream
}

type searcherServiceSubscribePendingTransactionsServer struct {
	grpc.ServerStream
}

func (x *searcherServiceSubscribePendingTransactionsServer) Send(m *PendingTxNotification) error {
	return x.ServerStream.SendMsg(m)
}
...
func _SearcherService_GetNextScheduledLeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/searcher.SearcherService/GetNextScheduledLeader",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SearcherService_GetConnectedLeaders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/searcher.SearcherService/GetConnectedLeaders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SearcherService_GetConnectedLeadersRegioned_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/searcher.SearcherService/GetConnectedLeadersRegioned",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SearcherService_GetTipAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/searcher.SearcherService/GetTipAccounts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SearcherService_GetRegions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/searcher.SearcherService/GetRegions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SearcherService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribePendingTransactions",
			Handler:       _SearcherService_SubscribePendingTransactions_Handler,
			ServerStreams: true,
		},
		{
